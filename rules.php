...
<html>
	...
	<body>
		...
		<div class="middleContent">
			<h1>How to Play Santase</h1>
			<p>
			Santase (pronounced SAN-tah-say) is a two-person card game that's popular in Bulgaria. The Santase rules are a little tricky but, once learned, the game is highly addictive. The card game rules are similar to those used in 66, and an Austrian game called Schnapsen.
			</p>

			<h2>Number of Players</h2>
			<p>Santase is a card game for 2 people.</p>
			...
			<p>9's = 0 points</p>
			<p class="noMargin">J = 2 points</p>
			<p class="noMargin">Q = 3 points</p>
			<p class="noMargin">K = 4 points</p>
			<p class="noMargin">10's = 10 points</p>
			<p class="noMargin">A = 11 points</p>

			<h2>Closing the Deck</h2>
			<p>
